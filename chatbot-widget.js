document.addEventListener("DOMContentLoaded", function () {
    ...
    const faq = {
        // ================== ENGLISH ==================
        "Hello|Hi|Hey": `Hello! Welcome to Lucky Panda Coin!
...
Just ask away - I promise I'm quieter than a sleeping panda! 🤪`,
        ...
        // ================== SPANISH GREETINGS ==================
        "Hola|Buenas|Oye": `¡Hola! Bienvenido a Lucky Panda Coin!
...
尽管问吧——我保证比打盹的熊猫还安静！🤪`,
        ...
        // ================== JAPANESE GREETINGS ==================
        "こんにちは|やあ|こんばんは": `こんにちは！Lucky Panda Coinへようこそ！
...
何でも聞いてくださいね。寝てるパンダより静かですよ〜 🤪`,
    ...
    function getBotResponse(userInput) {
        ...
        return "Sorry, I didn't understand that. Ask something about Lucky Panda Coin!";
    }
