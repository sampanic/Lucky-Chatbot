...
"Blockchain used": "Lucky Panda Coin is built on the Solana blockchain.",
 "What's the token address or contract address?|Token address|Contract address|Address": "The address will be announced at launch.",
...
"X": "https://x.com/luckyPandaCoin",
  ...
  "How do you do the giveaways?": "We do a random daily drawing, just correctly find the Lucky Panda in the day's image and share the post!",
        ...
        // ================== SPANISH ==================
        "¿Es Lucky Panda Coin solo otra moneda de perros o gatos intentando surfear la ola de los memes?": 
        "¡Para nada! Los pandas son los campeones de los memes: tiernos, torpes y listos para la acción. Lucky Panda Coin trae diversión con sabor a bambú al mundo crypto, con una comunidad llena de buenas vibras e inversión sencilla.",
    
    "¿Qué evita que Lucky Panda Coin se hunda como mi última cita de Tinder?": 
        "A diferencia de tu vida amorosa, tenemos una comunidad sólida y tecnología blockchain con IA para mantener la estabilidad. ¡Los pandas no ghostean—solo toman siestas y regresan más fuertes!",
    
    "¿Puedo comprar un panda real con Lucky Panda Coin?": 
        "Tentador, pero no. Los pandas están muy ocupados comiendo bambú como para interesarse en crypto. ¡Únete a nuestra comunidad y adopta un panda virtual—mucho menos lío!",
    
    "¿Por qué confiar en una moneda llamada como un oso que ni siquiera sabe trepar árboles?": 
        "¡Los pandas pueden tropezar, pero siempre caen de pie! Lucky Panda Coin se basa en confianza, transparencia y una comunidad que te respalda—sin necesidad de trepar árboles.",
    
    "¿Esta moneda me hará rico o solo me hará reír?": 
        "¿Por qué elegir? Únete a la familia Lucky Panda para reír a montones, y quién sabe—¡la luna se ve muy acogedora para pandas últimamente!",
    
    "¿De qué trata todo esto de IA? ¿Lucky Panda Coin está manejado por robots?": 
        "¡No hay robots, solo tecnología inteligente! Usamos IA para hacer el crypto simple y seguro, así tú te enfocas en divertirte mientras nosotros hacemos lo técnico.",
    
    "¿Cómo sé que Lucky Panda Coin no es una estafa como la 'inversión' en frijoles mágicos de mi primo?": 
        "¡Aquí no hay frijoles mágicos! Lucky Panda Coin es legítimo, con tecnología blockchain real y una comunidad abierta. Lee nuestro whitepaper—es mucho mejor que los esquemas de tu primo.",
    
    "¿Puedo usar Lucky Panda Coin para comprar bambú para mi panda mascota?": 
        "¿Tienes un panda de mascota? ¡Qué lujo! No puedes comprar bambú directamente, pero intercambia Lucky Panda Coin en nuestro mercado comunitario—¡quizá consigas snacks de panda!",
    
    "¿Será Lucky Panda Coin el próximo Bitcoin o solo otra copia crypto?": 
        "Bitcoin es genial, ¡pero nosotros somos el tierno underdog! Lucky Panda Coin crea su propio camino con memes, comunidad y un toque de magia de IA. ¡Súbete!",
    
    "¿De qué sirve Lucky Panda Coin si no puedo presumirlo en Instagram?": 
        "¡Claro que puedes presumir! Crea NFTs de Lucky Panda, únete a nuestros retos comunitarios y muestra tu orgullo panda. ¡Tu Instagram está por volverse más tierno!",
    
    "¿Qué es Lucky Panda Coin?": 
        "Lucky Panda Coin es una criptomoneda basada en memes con un toque divertido y gratificante.",
"¿Cuál es la dirección del token o del contrato?|Dirección del token|Dirección del contrato|Dirección": "La dirección se anunciará en el lanzamiento.","Cadena": "Blockchain de Solana.",
...
"¿Qué es una moneda meme?": "Una moneda meme es una criptomoneda inspirada en memes de Internet, bromas o tendencias culturales. ¡Suele ser divertida y dirigida por la comunidad!",
  ...
  "¿Cómo hacen los sorteos?": "Hacemos un sorteo diario. ¡Solo encuentra al Lucky Panda en la imagen del día y comparte la publicación!",
        ...
        // ================== CHINESE ==================
        "幸运熊猫币只是另一种跟风狗狗币的模因币吗？": 
        "才不是呢！熊猫才是模因界的终极冠军——可爱、笨拙又活力十足！幸运熊猫币为加密货币带来竹香四溢的乐趣，我们的社区充满正能量，投资轻松又愉快。",
    
    "幸运熊猫币凭什么不会像我的Tinder约会那样崩盘？": 
        "跟你的爱情生活不同，我们有强大的社区和AI区块链技术保驾护航。熊猫从不玩消失——它们只是打个盹，然后满血归来！",
    
    "能用幸运熊猫币买真熊猫吗？": 
        "想得美！熊猫忙着啃竹子才没空理加密货币。加入我们社区领养虚拟熊猫吧——还不用打扫粪便！",
    
    "我为什么要相信一种连树都爬不好的熊命名的币？": 
        "熊猫可能会摔跤，但总能四脚着地！幸运熊猫币建立在信任、透明和力挺你的社区基础上——完全不需要爬树技能。",
    
    "这币能让我暴富还是只能逗我一笑？": 
        "何必二选一？加入幸运熊猫大家庭收获快乐，说不定——最近月球对熊猫特别友好哦！",
    
    "这些AI宣传是什么情况？幸运熊猫币是机器人运作的吗？": 
        "没有机器人，只有智能科技！我们用AI简化加密技术保障安全，您只管开心玩耍，复杂交给我们。",
    
    "怎么确定幸运熊猫币不是我表弟'魔法豆'投资那样的骗局？": 
        "这里可没有魔法豆！幸运熊猫币是真正的区块链项目，社区完全开放。看看白皮书——比您表弟的把戏靠谱多了。",
    
    "能用幸运熊猫币给我的宠物熊猫买竹子吗？": 
        "养熊猫当宠物？土豪啊！虽然不能直接买竹子，但可以在社区市场交易熊猫零食！",
    
    "幸运熊猫币会成为下一个比特币还是又一个小跟班？": 
        "比特币很棒，但我们是萌系潜力股！幸运熊猫币用模因、社区和AI魔法开辟独特道路。快上车！",
    
    "如果不能在Instagram炫耀，幸运熊猫币还有什么意义？": 
        "炫起来！铸造幸运熊猫NFT，参加社区挑战，秀出你的熊猫骄傲。你的Ins即将萌力爆表！",
    
    "什么是幸运熊猫币？": 
        "幸运熊猫币是一种兼具趣味性和奖励机制的模因加密货币。",
"代币地址或合约地址是什么？|代币地址|合约地址|地址":
        "地址将在发布时公布。","链": "Solana 区块链。",
...
"什么是meme币？": "Meme币是一种受互联网梗图、笑话或文化潮流启发的加密货币，通常以趣味和社区驱动为特点！",
  ...
  "你们是怎么做赠币活动的？": "每天举办随机抽奖。找到当天图片中的Lucky Panda并分享即可参与！",
        ...
        // ================== JAPANESE ==================
        "ラッキーパンダコインはただの犬や猫コインの真似ですか？": 
        "とんでもない！パンダはミーム界のチャンピオン——可愛くて不器用、でもやる気満々！ラッキーパンダコインは竹パワーで暗号通貨を楽しくし、良い雰囲気のコミュニティで簡単投資を実現します。",
    
    "ラッキーパンダコインがTinderのデートみたいに崩壊しない理由は？": 
        "あなたの恋愛と違い、私たちには強固なコミュニティとAIブロックチェーン技術があります。パンダは幽霊化しない——昼寝して強く戻ってくるだけ！",
    
    "ラッキーパンダコインで本物のパンダを買えますか？": 
        "魅力的ですが無理です。パンダは竹を食べるのに忙しくて暗号通貨に関心ありません。コミュニティに参加してバーチャルパンダを飼いましょう——後片付けも楽ですよ！",
    
    "木も登れないクマの名前のコインをなぜ信じるべき？": 
        "パンダは転んでもすぐ起き上がります！ラッキーパンダコインは信頼、透明性、あなたを支えるコミュニティで構築されています——木登りスキル不要です。",
    
    "このコインで儲かる？それともただ笑えるだけ？": 
        "選ぶ必要なんてありません！ラッキーパンダクルーで大笑いしながら、もしかしたら——月がパンダに優しい時代ですよ！",
    
    "このAIの話は何？ラッキーパンダコインはロボットが運営？": 
        "ロボットじゃありません、スマート技術です！AIで暗号通貨をシンプルで安全にし、あなたは楽しむだけ——難しいことは私たちがやります。",
    
    "いとこの'魔法の豆'投資のような詐欺じゃないとどうわかる？": 
        "魔法の豆なんてありません！ラッキーパンダコインは本物のブロックチェーンテクノロジーとオープンなコミュニティです。ホワイトペーパーをチェック——いとこの計画よりずっとマシですよ。",
    
    "ラッキーパンダコインでペットのパンダに竹を買えますか？": 
        "パンダをペットに？お洒落ですね！直接竹は買えませんが、コミュニティマーケットでパンダスナックをゲットできるかも！",
    
    "ラッキーパンダコインは次のビットコイン？それともただのコピー？": 
        "ビットコインはクールですが、私たちは愛らしいアンダードッグ！ミームとコミュニティ、AIの魔法で独自の道を切り拓きます。乗り遅れないで！",
    
    "Instagramで自慢できないならラッキーパンダコインの意味は？": 
        "自慢できますよ！ラッキーパンダNFTをミントし、コミュニティチャレンジに参加して、パンダプライドをアピールしましょう。あなたのインスタがもっと可愛くなります！",
    
    "ラッキーパンダコインとは？": 
        "ラッキーパンダコインは、楽しくやりがいのあるミームベースの暗号通貨です。","トークンアドレスまたはコントラクトアドレスは？|トークンアドレス|コントラクトアドレス|アドレス": "アドレスは発売時に発表されます。","チェーン": "Solana ブロックチェーン。",
...
"ピザトッピング": "もちろん竹追加 - パンダのお気に入り！🐼🎋",
  ...
  "プレゼント企画はどうやるの？": "画像からLucky Pandaを見つけて投稿をシェアすれば、抽選に参加できます！"
    ...
    function getBotResponse(userInput) {
        ...
        if (!userInput) return "Please ask a question!";

        // First try exact matches (including multi-keyword matches)
        for (let key in faq) {
        ...
        // Then try partial matches with priority to longer matches
        let bestMatch = null;
        ...
        for (let key in faq) {
            ...
            for (let keyword of keywords) {
                ...
                // Score based on:
                // 1. If the keyword is contained in the user input
                // 2. The length of the matching keyword (longer matches are better)
                // 3. Position of the match (earlier matches are better)
                
                if (userInput.includes(keywordLower)) {
                    const score = keywordLower.length * 2;
                    if (score > bestMatchScore) {
                        bestMatchScore = score;
                        bestMatch = faq[key];
                    }
                }
                // Also check if user input is contained in the keyword
                else if (keywordLower.includes(userInput)) {
                    const score = userInput.length;
                    if (score > bestMatchScore) {
                        bestMatchScore = score;
                        bestMatch = faq[key];
                    }
        ...
        // Finally, try word-by-word matching if no good match found
        const userWords = userInput.split(/\s+/);
        for (let key in faq) {
            const keywords = key.split("|");
            for (let keyword of keywords) {
                const keywordWords = keyword.toLowerCase().split(/\s+/);
                // Check if all words in keyword exist in user input
                if (keywordWords.every(kw => userWords.some(uw => uw.includes(kw) || kw.includes(uw)))) {
                    return faq[key];
                }
            }
        }
